        ...
        <div className="max-w-md mx-auto mt-20">
            <div className="bg-slate-800/50 border border-slate-700 p-8 rounded-3xl backdrop-blur-md shadow-2xl">
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-400">Join the SI2 UAS library community.</p>
                </div>
                ...
                <form onSubmit={handleRegister} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <LucideShield className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-500" />
                            <select
                                value={role}
                                onChange={(e) => setRole(e.target.value)}
                                className="w-full bg-slate-900/50 border border-slate-700 rounded-xl py-3 pl-12 pr-4 focus:border-blue-500 outline-none transition-colors appearance-none"
                            >
                    ...
                    <button
                        disabled={loading}
                        className="w-full bg-purple-600 hover:bg-purple-500 py-4 rounded-xl font-bold flex items-center justify-center transition-all active:scale-[0.98] disabled:opacity-50"
                    >
                        {loading ? <LucideLoader2 className="w-5 h-5 animate-spin mr-2" /> : "Register"}
                    </button>
                </form>
